    ...
    return(
        <div className="h-screen bg-primary flex items-center justify-center">
          <div className="authentication-form bg-white p-3 rounded">
            <h1 className="text-secondary text 2xl font-bold mb-1">BLUESTONE LIBRARY-REGISTER</h1>
            <hr/>
            ...
            onFinish={onFinish}>
                <Form.Item
                 ...
                 rules={[
                    ...
                    <input type="text" id="name" placeholder="Name" value={name} onChange ={e=>setName(e.targetvalue)}/>
                </Form.Item>
                <Form.Item
                label="Email"
                name ="email"
                ...
                name ="phone"
                 rules={[
                    ...
                    <input type="number" placeholder="Phone"id="phone" value={phone}onChange ={e=>setPhone(e.targetvalue)}/>
                </Form.Item>
                <Form.Item
                label="Password"
                name="password"
